...
/*  mesh, often no neighboring subsegments are present.  Such fabsent         */
...
/* Which of the following two methods of finding the fabsolute values is      */
...
#define fabsolute(a)  ((a) >= 0.0 ? (a) : -(a))
/* #define fabsolute(a)  fabs(a) */
...
float counterclockwiseadapt(vertex pa, vertex pb, vertex pc, float detsum)
{
  ...
  errbound = ccwerrboundC * detsum + resulterrbound * fabsolute(det);
...
float incircleadapt(vertex pa, vertex pb, vertex pc, vertex pd, float permanent)
{
  ...
  errbound = iccerrboundC * permanent + resulterrbound * fabsolute(det);
              ...
              vertex pa, vertex pb, vertex pc, vertex pd)
{
  ...
  permanent = (fabsolute(bdxcdy) + fabsolute(cdxbdy)) * alift
            + (fabsolute(cdxady) + fabsolute(adxcdy)) * blift
            + (fabsolute(adxbdy) + fabsolute(bdxady)) * clift;
                   ...
                   float permanent)
{
  ...
  errbound = o3derrboundC * permanent + resulterrbound * fabsolute(det);
              ...
              float aheight, float bheight, float cheight, float dheight)
{
  ...
  permanent = (fabsolute(bdxcdy) + fabsolute(cdxbdy)) * fabsolute(adheight)
            + (fabsolute(cdxady) + fabsolute(adxcdy)) * fabsolute(bdheight)
            + (fabsolute(adxbdy) + fabsolute(bdxady)) * fabsolute(cdheight);
