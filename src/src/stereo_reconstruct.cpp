...
namespace stereo_reconstruct {
    ...
    private:
        virtual void onInit() {
            ...
            image_left_.subscribe(left_it, "/GroundCameraLeft/image_raw", 1, hintsLeft);
            image_right_.subscribe(right_it, "/GroundCameraRight/image_raw", 1, hintsRight);
            camera_info_left_.subscribe(left_nh, "/left/camera_info", 1);
            camera_info_right_.subscribe(right_nh, "/right/camera_info", 1);
