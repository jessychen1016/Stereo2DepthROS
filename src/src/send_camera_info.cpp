...
int main(int argc, char **argv)
{
  ...
  while (ros::ok())
  {
    ...
    cam_info_left.header.stamp.sec = 157379094;
    cam_info_left.header.stamp.nsec = 976513000;
    cam_info_left.width = 640;
    cam_info_left.height = 480;
    ...
    cam_info_right.header.stamp.sec = 157379094;
    cam_info_right.header.stamp.nsec = 976513000;
    cam_info_right.width = 640;
    cam_info_right.height = 480;
